...
public class MessageExample {
     ...
     * 此处替换成您的appKey
     * */
    private static final String appKey = "k51hidwqk4icb";
    /**
     * 此处替换成您的appSecret
     * */
    private static final String appSecret = "02hEdHbsDuB";
    ...
    public static void main(String[] args) throws Exception {
        ...
        HistoryMessageResult historyMessageResult = (HistoryMessageResult)history.get("2019111920");
