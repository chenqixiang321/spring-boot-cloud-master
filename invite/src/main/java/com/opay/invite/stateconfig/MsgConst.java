...
public class MsgConst {
     ...
     public static String betting ="Bouns on invitees using Betting";

     public static String oride="Bouns on invitees using Oride";

     public static String agentTask ="";
     ...
     public static String task2 ="1st Top-Up";

     public static String task3 ="Use Airtime";

     public static String task4 ="Use Betting";
