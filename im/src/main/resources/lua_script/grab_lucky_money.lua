...
if exists == 0 then
    return "[\"com.opay.im.model.response.GrabLuckyMoneyResult\",{\"code\":\"20001\",\"message\":\"The lucky money does not exist or has expired\"}]"
end
if redis.call("hget", lucky_money_key_set, "payStatus") ~= "1" then
    return "[\"com.opay.im.model.response.GrabLuckyMoneyResult\",{\"code\":\"20004\",\"message\":\"The lucky money unpaid\"}]"
end
...
if grab_user == nil or grab_user == false then
    ...
    if id == false or id == nil then
        return "[\"com.opay.im.model.response.GrabLuckyMoneyResult\",{\"code\":\"20002\",\"message\":\"The lucky money has been robbed\"}]"
    end
    redis.call("hset", lucky_money_key_set, "grab_user:" .. grab_user_id, id)
    local amount = redis.call("hget", lucky_money_key_set, id)
    return "[\"com.opay.im.model.response.GrabLuckyMoneyResult\",{\"code\":\"00000\",\"id\":" .. id .. ",\"amount\":" .. amount .. "}]"
else
    local amount = redis.call("hget", lucky_money_key_set, grab_user)
    return "[\"com.opay.im.model.response.GrabLuckyMoneyResult\",{\"code\":\"20003\",\"id\":" .. grab_user .. ",\"amount\":" .. amount .. ",\"message\":\"You have robbed this lucky money\"}]"
end
